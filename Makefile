...
SOURCE_DIR := $(BUILD_ROOT)/actor-framework/
BUILD_TYPE = Release
BUILD_DIR = ${REZ_BUILD_PATH}/BUILD/$(BUILD_TYPE)

# Source
REPOSITORY_URL := https://github.com/actor-framework/actor-framework.git
...
ifeq "$(TAG)" "vNOT_SET"
$(warning "No tag was specified, main will be built. You can specify a tag: TAG=0.18.4")
TAG:=master
endif
